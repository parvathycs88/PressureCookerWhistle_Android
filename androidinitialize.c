...
extern void onAudioCaptureStateChange(int i);
...
void JNICALL naOnAppStateChange(JNIEnv *pEnv, jobject pObj, jint state)
{
    ...
    switch(state) {
        ...
        case 2:
            ...
            break;
        case 3:
            onAudioCaptureStateChange(3);
            break;
        case 4:
            onAudioCaptureStateChange(4);
            break;
        case 5:
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* pVm, void *reserved)
{
    ...
    nm[0].name = "naMain";
    nm[0].signature =
            "([Ljava/lang/String;Lcom/example/matlabfcn_whistlecount/matlabfcn_whistlecount;)I";
    ...
    jclass cls = (*env)->FindClass(env,
            "com/example/matlabfcn_whistlecount/matlabfcn_whistlecount");

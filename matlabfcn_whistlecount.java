...
public class matlabfcn_whistlecount extends AppCompatActivity implements OnFragmentInteractionListener{
    ...
    private String[] scopeTitles = {"Classifier Output"};
    ...
    private matlabfcn_whistlecount thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","matlabfcn_whistlecount"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("matlabfcn_whistlecount.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
...
timerZoomButton.start();
    ...
    private native int naMain(String[] argv, matlabfcn_whistlecount pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("matlabfcn_whistlecount");
    }
